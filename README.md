...
| `GET` | `/api/candidates` | List paginated candidates (`page`, `page_size`, `q`, `work_authorization`, `location`, `linkedin_profile`, `domain_industry`, `preferred_location`, `open_to_relocation`, `expected_salary`, `employment_type`, `skills`) |
